...
class Handlers:
    ...
    def handle_smalltalk(self, match=None) -> str:
        import random
        responses = [
            "Я чат-бот Димсн, умею: узнавать погоду, говорить время, поддерживать беседу. Попробуйте спросить 'какая погода?' или 'который час?'",
            ...
            "Я бот-помощник Димсн. Могу рассказать погоду в любом городе, сообщить текущее время или просто поговорить.",
